...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5317124316').split()]
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "ɴᴀᴍᴇ: <code>{file_name}</code> \n\nJOIN NOW: [ABC MOVIES](https://t.me/abcmovies_site)\n\nJOIN NOW: [Koundinya Movies](https://t.me/koundinya_moviez)</b>")
